...
export const Sidebar = ({ isOpen, onClose }: SidebarProps) => {
  ...
  const { canCreate, isPharmacist, isAdmin, isDoctor, isNurse, isReception, isLabTech, isPatient } = usePermissions();
  ...
  const getUserRole = () => {
    ...
    if (isLabTech) return 'lab_technician';
  ...
  const menuItems = [
    {
      ...
      roles: ['admin', 'doctor', 'nurse', 'reception', 'lab_technician'],
    },
    {
    ...
    },
    {
      ...
      roles: ['admin', 'doctor', 'nurse', 'reception', 'pharmacist', 'lab_technician', 'patient'],
    },
  ];
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center h-16 px-6 border-b border-gray-200">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-xl font-bold text-primary">HealthPulse</span>
            </div>
          </div>
